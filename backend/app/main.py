...
from app.api.phase_labels import router as phase_labels_router
from app.api.phase_types import router as phase_types_router
...
app.include_router(phase_labels_router, prefix="/api")
app.include_router(phase_types_router, prefix="/api")
