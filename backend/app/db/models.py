...
class ProjectPanel(Base):
    ...
    # Proje özgü kabin geometrisi (kütüphaneden kopyalanır, proje içinde düzenlenebilir)
    width_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("100"))
    height_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("200"))
    depth_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    mounting_plate_width_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    mounting_plate_height_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    left_margin_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    right_margin_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    top_margin_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    bottom_margin_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    busbar_orientation: Mapped[str | None] = mapped_column(Text, nullable=True)
    phase_system: Mapped[str | None] = mapped_column(Text, nullable=True)
    busbar_rail_offset_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    busbar_end_setback_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    origin_x_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    origin_y_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
    origin_z_mm: Mapped[Decimal] = mapped_column(Numeric, nullable=False, default=Decimal("0"))
...
class TerminalDefinition(Base):
    ...
    fin_spacing_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)     # fin aralığı, merkez-merkez (mm)
    ...
    fin_offset_mm: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)      # yüzey kenarından ilk finin üst kenarına mesafe (mm)
